...
for root,d_names,f_names in os.walk(all_files):
    for f in f_names:
        ...
        if filename.find(".") != -1:
            ...
            # print(place_exists)
            if blif_exists and complete_blif_filename not in done:
                done.add(complete_blif_filename)
                ...
                while True: # going through all the files that were done
                    ...
                    print("         "+new_line)
                    got_same_file = new_line.find(str(filename_array[0]))>-1 and len(new_line)>=len("/home/ramanath/all_files/") and new_line[:len("/home/ramanath/all_files/")] == "/home/ramanath/all_files/"
                    # print(got_same_file)
                    if got_same_file:
